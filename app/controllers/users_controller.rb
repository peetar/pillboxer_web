class UsersController < ApplicationController
  ...
  def create
    ...
    if user.save
      ...
      redirect_to root_path, notice: "Account created successfully! Welcome to Pill Boxer, #{user.name}!"
    else
      error_message = user.errors.full_messages.join(", ")
      html = generate_signup_html(error_message)
      render html: html.html_safe
    end
  end
  ...
  def generate_signup_html(error_message = nil)
    csrf_token = form_authenticity_token
    <<~HTML
      <!DOCTYPE html>
      <html>
      <head>
        <title>Sign Up - Pill Boxer</title>
        ...
        <div class="container">
          <div class="card">
            <div class="header">
              ...
              <p>Join Pill Boxer to manage your medications</p>
            </div>
